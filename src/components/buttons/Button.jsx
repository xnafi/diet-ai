...
export default function Button({ href, children }) {
  const content = (
    <>
      ...
      <p className="text-sm pl-10">{children}</p>
    </>
  );
  const baseStyle =
    "secondaryColorBg text-center w-full rounded-2xl h-10 lg:h-14 relative text-black text-xl font-semibold group pl-8 pr-4";
